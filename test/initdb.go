...
// getTableName return a new table name
...
// generateSkey generate secret key
...
// createTable create a new table schema
func createTable() {
...
// insertRecord insert records into db
func insertRecord() {
    db.LogMode(false)
